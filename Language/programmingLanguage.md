# Programming Language Recipe

&nbsp; 프로그래밍 언어를 학습하거나 관련 언어를 활용하는 회사 인터뷰를 대비하기 위한 레시피 입니다. 직접 학습 및 개발하고, 인터뷰를 경험하며 작성 했습니다. 필요한 레시피를 편하게 얻어가시고, 원하는 레시피는 `ISSUE`에 등록, 추가하고 싶은 레시피와 잘못된 레시피는 `PR`에 등록해주시면 감사하겠습니다.
